      ...
      <div className="relative flex flex-col justify-start px-6 md:px-12 lg:px-20 pt-12 pb-0">
        <div className="max-w-7xl mx-auto w-full">
          ...
          <p className="text-sm sm:text-base md:text-base lg:text-sm xl:text-lg leading-relaxed text-[#f4f4f4] mb-8">
            El registro de lo que construimos junto a artistas, bandas y
            público en cada producción.
          </p>
        </div>
      </div>
    </div>
    ...
    <Link
      ...
      style={{
        ...
        transition: `opacity 0.7s cubic-bezier(0.16,1,0.3,1) ${
          idx * 0.15
        }s, transform 0.7s cubic-bezier(0.16,1,0.3,1) ${idx * 0.15}s`,
      }}
    >
      <div
      ...
      >
        ...
        <div className="absolute bottom-0 left-0 h-[3px] w-0 bg-red-600 transition-all duration-500 group-hover:w-full" />
      </div>
