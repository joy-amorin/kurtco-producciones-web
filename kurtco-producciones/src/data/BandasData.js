export const bandas = [
    ...
    },
    {
      nombre: "Inefable",
      slug: "inefable",
      foto: "https://images.unsplash.com/photo-1470229722913-7c0e2dbbafd3?w=800&q=80",
      genero: "Heavy Metal",
      bio: "Acero y Fuego lleva el metal uruguayo a otro nivel. Con una propuesta técnica impecable y letras profundas, la banda ha compartido escenario con grandes nombres internacionales. Su dedicación al género y su profesionalismo los han convertido en embajadores del metal nacional.",
      links: {
        spotify: "https://spotify.com",
        instagram: "https://instagram.com",
        youtube: "https://youtube.com"
    ...
    },
    {
      ...
      bio: "Reverb explora los límites del rock con una propuesta experimental que incorpora electrónica, noise y elementos psicodélicos. Su sonido único y sus shows inmersivos han captado la atención de la crítica y el público más aventurero.",
      links: {
        spotify: "https://spotify.com",
        instagram: "https://instagram.com"
      }
